...
experiment TrafficSimulation type: gui {
    ...
    output {
        display MainView type: opengl axes: false background: rgb(46, 139, 87) {
            camera 'default' location: {120.0, 50.0, 190.0} target: {120.0, 50.0, 0.0};  // center x=120 (road 240), zoom out
            ...
            overlay position: {20 #px, 20 #px} size: {760 #px, 650 #px}
                ...
                if (show_dashboard) {
                    ...
                    draw "BẢNG ĐIỀU KHIỂN RL — NHẬP LÀN CAO TỐC" at: {15 #px, 38 #px}
                    ...
                    if (tracked = nil) {
                        ...
                        if (tracked.is_rl_agent) {
                            tracked_title_prefix <- "Đang theo dõi: RL ";
