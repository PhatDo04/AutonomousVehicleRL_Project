...
- Môi trường **chấm điểm** (gọi là **reward** — "phần thưởng"): nhập làn an toàn được thưởng (**+50 điểm** lúc nhập, cộng thêm điểm theo tiến độ mỗi bước), đâm xe bị **−100 điểm**.
...
KẾT THÚC khi một trong các điều sau xảy ra với xe tím:
   • Nhập làn xong + chạy hết đường   → "success" (+50 điểm lúc nhập + thưởng tiến độ) 🎉
...
- Nhập làn thành công: **+50** (thưởng một lần khi nhập; phần lớn điểm đến từ thưởng-tiến-độ cộng dồn mỗi bước → đích nhắm).
...
- **Giai đoạn 1 (kết thúc ngay khi nhập làn): MAA2C giỏi & ổn định nhất** — ~82–89% thành công, ít thất thường hơn MAPPO (lưu ý: đo ở chế độ "lấy mẫu"; xem giai đoạn 2 vì sao thứ hạng đổi).
- **Giai đoạn 2 (khó hơn: nhập xong phải TỰ LÁI TIẾP tới cuối đường, đường đông):** sau khi sửa một lỗi nền tảng (tín hiệu "ván kết thúc" bị thất lạc giữa GAMA và Python) + thưởng-theo-tiến-độ, **xe học (PPO) đạt 86±6%** (qua 3 lần huấn luyện độc lập) còn luật tham lam chỉ 53±12% (đâm 47±12%, và **sụp về 0% khi bỏ lưới an toàn**). Có checkpoint xe cao tốc *chủ động nhường* tới **89±6%**; train thêm thì xe nhập làn *tự tìm khe* khéo tới mức không cần ai nhường (kiểu khóa kéo — zipper). Ở chế độ chạy "chắc chắn" (tất định), PPO vượt hẳn A2C — A2C chỉ tốt khi "lấy mẫu ngẫu nhiên".
